...
public class VentanaInicial extends BorderPane{
	...
	public VentanaInicial (Stage stage) {
        ...
        ToggleButton botonSonidoActivado = new ToggleButton();
        ImageView imagen2 = new ImageView();
        botonSonidoActivado.setGraphic(imagen2);
        imagen2.imageProperty().bind(Bindings.when(botonSonidoActivado.selectedProperty())
            .then(sinSonido)
            .otherwise(conSonido)
        );
        ...
        botonSonidoActivado.setStyle("-fx-border-color: transparent; -fx-background-color: transparent; ");
        ...
        VBox contenedorVertical2 = new VBox(botonSonidoActivado);
