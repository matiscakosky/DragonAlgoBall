...
public class ContenedorGanadorEnemigosDeLaTierra extends BorderPane{
	public ContenedorGanadorEnemigosDeLaTierra(Stage stage){
        stage.setFullScreen(false);
        stage.setMaximized(false);
        this.setPadding(new Insets(40));
        Image imagen = new Image("file:src/vista/Imagenes/GanadorEquipoEnemigos.jpg");
