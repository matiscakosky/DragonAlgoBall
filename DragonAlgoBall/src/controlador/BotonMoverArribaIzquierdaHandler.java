...
public class BotonMoverArribaIzquierdaHandler implements EventHandler<ActionEvent> {
	DragonAlgoBall juego;
	ContenedorPrincipal contenedor;
	Turno turno;
	
	public BotonMoverArribaIzquierdaHandler(DragonAlgoBall juego, ContenedorPrincipal contenedor){
		this.juego = juego;
    ...
    public void handle(ActionEvent actionEvent) {
        ...
        try {
            aMover.MoverPersonajeHaciaArribaIzquierda();
        ...
        contenedor.cambioDeTurnoEnCasoQueSeaNecesario();
    }
